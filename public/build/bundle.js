	        ...
	        return React.createElement(
	            ...
	            React.createElement(
	                ...
	                React.createElement(
	                    ...
	                    React.createElement(
	                        "div",
	                        { className: "col-sm-6 social-icons" },
	                        React.createElement(
	                            "a",
	                            { href: "#" },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(148);
	var Features = __webpack_require__(213);
	    ...
	    render: function render() {
	        return React.createElement(
	            ...
	            React.createElement(
	                ...
	                React.createElement(
	                    "div",
	                    { className: "col-lg-6 col-lg-push-3 col-md-6 col-md-push-3 col-sm-8 col-sm-push-2 col-xs-12 container get-it" },
	                    React.createElement(
	                        "h1",
	                        null,
	                        React.createElement(
	                    ...
	                    React.createElement(
	                        "p",
	                        null,
	                        "Personal finance Management just got better."
	                    ),
	                    React.createElement(
	                        "p",
	                        null,
	                        React.createElement(
	                            "a",
	                            { className: "btn btn-success btn-lg", role: "button", href: "#" },
	                            React.createElement("span", { className: "fa fa-google" }),
	                            "Google Play"
	                        ),
	                        React.createElement(
	                            "a",
	                            { className: "btn btn-primary btn-lg", role: "button", href: "" },
	                            React.createElement("span", { className: "fa fa-apple" }),
	                            "App Store"
	                        )
	                    )
	                )
	            ...
	            React.createElement(
	                "section",
	                { id: "fcards", className: "features" },
	                React.createElement(Features, { url: "./assets/data/featuresCard.json" })
	            )
	        );
	    }
	});
	...
	var Features = React.createClass({
	  ...
	  render: function render() {
	    ...
	    this.state.data.forEach(function (value, index) {
	      var i = index % 2;
	      cards.push(React.createElement(Cards, { name: value.name, desc: value.description, key: value.name, classCol: classes[i], icon: value.icons }));
	    });
	    return React.createElement(
	      "div",
	      { className: "row" },
